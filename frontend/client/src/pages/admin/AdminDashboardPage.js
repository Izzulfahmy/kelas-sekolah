...
// --- Scoped CSS Styles ---
// All styles are now included directly in the component and scoped to avoid conflicts.
const DashboardStyles = () => (
    <style>{`
        ...
        #admin-dashboard-scoped .dashboard-container-revamped {
            padding: 24px;
            max-width: 1600px;
            margin: auto;
        }

        #admin-dashboard-scoped .dashboard-header {
            display: flex;
        ...
        #admin-dashboard-scoped .dashboard-header h1 {
            font-size: 28px;
            font-weight: 700;
        ...
        #admin-dashboard-scoped .dashboard-header p {
            font-size: 16px;
            color: var(--text-secondary);
            margin: 4px 0 0 0;
        }

        #admin-dashboard-scoped .header-actions {
            display: flex;
            gap: 12px;
        }

        #admin-dashboard-scoped .header-actions .ant-btn {
            border-radius: 8px;
            font-weight: 500;
        }

        #admin-dashboard-scoped .main-stats-grid {
            display: grid;
            grid-template-columns: repeat(auto-fit, minmax(220px, 1fr));
            gap: 24px;
        }

        #admin-dashboard-scoped .stat-card-revamped {
        ...
        #admin-dashboard-scoped .stat-card-revamped:hover {
            transform: translateY(-5px);
            box-shadow: var(--shadow-md);
        }

        #admin-dashboard-scoped .stat-card-revamped .ant-card-body {
            padding: 20px !important;
        }

        #admin-dashboard-scoped .stat-card-inner {
            display: flex;
            align-items: center;
            gap: 16px;
        }

        #admin-dashboard-scoped .stat-icon {
            width: 48px;
            height: 48px;
            border-radius: 50%;
            display: flex;
        ...
        #admin-dashboard-scoped .stat-info .ant-statistic-title {
            color: var(--text-secondary);
            font-size: 14px;
            margin-bottom: 4px;
        }

        #admin-dashboard-scoped .stat-info .ant-statistic-content {
            color: var(--text-primary);
            font-weight: 600;
            font-size: 24px;
        }

        #admin-dashboard-scoped .stat-trend {
            font-size: 12px;
            display: flex;
            align-items: center;
            gap: 4px;
        ...
        #admin-dashboard-scoped .stat-trend.positive { color: var(--green-color); }
        #admin-dashboard-scoped .stat-trend.negative { color: var(--red-color); }

        #admin-dashboard-scoped .content-card {
            background: var(--card-bg-color);
            border: 1px solid var(--border-color);
            border-radius: var(--border-radius);
            box-shadow: var(--shadow-sm);
        ...
        #admin-dashboard-scoped .content-card .ant-card-head-title {
            font-weight: 600;
            color: var(--text-primary);
        }

        #admin-dashboard-scoped .content-card .ant-card-body {
            padding: 24px;
        }

        #admin-dashboard-scoped .student-info {
            display: flex;
            align-items: center;
            gap: 12px;
            font-weight: 500;
        ...
        #admin-dashboard-scoped .gender-legend {
            display: flex;
            justify-content: center;
            gap: 20px;
            margin-top: 16px;
        ...
        #admin-dashboard-scoped .legend-item {
            display: flex;
            align-items: center;
            gap: 8px;
        }

        #admin-dashboard-scoped .legend-item .dot {
            width: 10px;
            height: 10px;
            border-radius: 50%;
        }

        #admin-dashboard-scoped .activity-icon {
            width: 36px;
            height: 36px;
            border-radius: 50%;
            display: flex;
        ...
        #admin-dashboard-scoped .ant-list-item-meta-title span {
            color: var(--text-primary);
            font-weight: 500;
        }

        #admin-dashboard-scoped .ant-list-item-meta-description {
            font-size: 12px;
        }

        #admin-dashboard-scoped .ant-picker-calendar {
            border: none;
        }

        #admin-dashboard-scoped .ant-picker-calendar .ant-picker-panel {
